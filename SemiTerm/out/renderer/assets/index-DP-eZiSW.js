...
function ConnectionEditor({ connection, onSave, onCancel }) {
  const [formData, setFormData] = reactExports.useState(initialConnectionState);
  ...
  const handleSave = () => {
    onSave({
      ...formData,
      id: connection?.id || "",
      // ID is handled by main process if empty
      createdAt: connection?.createdAt || "",
      updatedAt: connection?.updatedAt || ""
    });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: (open) => !open && onCancel(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-[480px] bg-[#1e293b] text-white border-gray-700", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: connection ? "接続情報を編集" : "新しい接続" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "SSHサーバーへの接続情報を入力してください。" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid w-full items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "title", children: "接続名" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "title", name: "title", value: formData.title, onChange: handleChange, className: "bg-gray-800 border-gray-600" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid w-full items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "host", children: "Host" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "host", name: "host", value: formData.host, onChange: handleChange, className: "bg-gray-800 border-gray-600" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid w-full items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "port", children: "Port" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "port", name: "port", type: "number", value: formData.port, onChange: handleChange, className: "bg-gray-800 border-gray-600" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid w-full items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "username", children: "Username" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "username", name: "username", value: formData.username, onChange: handleChange, className: "bg-gray-800 border-gray-600" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid w-full items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "認証方式" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { onValueChange: handleAuthTypeChange, defaultValue: formData.auth.type, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "bg-gray-800 border-gray-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "認証方式を選択" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "bg-gray-800 text-white border-gray-600", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "password", children: "パスワード" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "key", children: "秘密鍵" })
          ] })
        ] })
      ] }),
      formData.auth.type === "password" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid w-full items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "password", children: "Password" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "password", name: "password", type: "password", value: formData.auth.password || "", onChange: handleAuthChange, className: "bg-gray-800 border-gray-600" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid w-full items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "keyPath", children: "Key Path" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "keyPath", name: "keyPath", value: formData.auth.keyPath || "", onChange: handleAuthChange, className: "bg-gray-800 border-gray-600" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 pt-2", children: "パスワードは保存されません（毎回入力が必要です）。" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: onCancel, children: "Cancel" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleSave, disabled: !isValid, children: "Save" })
    ] })
  ] }) });
}
function ConnectionItem({ connection, onConnect, onEdit, onDelete }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Server, { className: "w-6 h-6 mr-4 text-gray-400" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-gray-100 truncate", children: connection.title }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "opacity-0 group-hover:opacity-100 transition-opacity", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", className: "mr-1", onClick: (e) => {
            e.stopPropagation();
            onEdit(connection);
...
function App() {
  ...
  const [tabs, setTabs] = reactExports.useState([{ id: "welcome", label: "Welcome" }]);
  const [activeTab, setActiveTab] = reactExports.useState("welcome");
  const [isEditorOpen, setEditorOpen] = reactExports.useState(false);
  ...
  const handleDeleteConnection = async (id2) => {
    if (confirm("この接続設定を削除してもよろしいですか？")) {
      const updatedConnections = await window.api.deleteConnection(id2);
      setConnections(updatedConnections);
    }
  };
  ...
  const openEditConnectionEditor = (connection) => {
    setEditingConnection(connection);
    setEditorOpen(true);
  };
  const addSshTab = (connection) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-screen h-screen bg-[#0f172a] text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-64 bg-[#1e293b] border-r border-gray-700 p-4 flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "接続先" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: openNewConnectionEditor, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-5 h-5" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 flex-1 overflow-y-auto", children: connections.map((conn) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ConnectionItem,
        {
          connection: conn,
          onConnect: addSshTab,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-500 mt-4", children: "SemiTerm v0.1.0" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-12 bg-[#1e293b] border-b border-gray-700 flex items-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, className: "flex-1 h-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsList, { className: "bg-transparent h-full p-0", children: tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        TabsTrigger,
        {
          value: tab.id,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[calc(100vh-3rem)] bg-[#0f172a]", children: tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: tab.id, className: "h-full p-0", children: tab.id === "welcome" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full text-gray-300", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl mb-4", children: ">_" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xl mb-6", children: "SemiTerm 軽量 SSH ターミナル" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: openNewConnectionEditor, children: "新しい接続を作成" })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 text-gray-400 h-full", children: [
        "SSHターミナル (ID: ",
        tab.id,
        ")"
      ] }) }, tab.id)) })
    ] }) }) }),
    isEditorOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectionEditor, { connection: editingConnection, onSave: handleSaveConnection, onCancel: () => setEditorOpen(false) })
  ] });
}
